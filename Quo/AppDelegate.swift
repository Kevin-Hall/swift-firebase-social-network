...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationBarAppearace.titleTextAttributes = [NSAttributedStringKey.foregroundColor:COLOR_TEXT, NSAttributedStringKey.font: UIFont(name: "Futura-MediumItalic", size: 18)!]
        
        navigationBarAppearace.tintColor = COLOR_TEXT
        navigationBarAppearace.barTintColor = COLOR_NAV_TOP
